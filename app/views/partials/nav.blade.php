<div id="main-nav" class="side-nav">
    <ul id="side-nav-list" class="side-nav-list">
        ...
        <li class="nav-item" id="nav-budgets">
            ...
            <ul class="sub-nav-list">
                <li class="nav-item"><a href="">New Budget</a></li>
                <li class="nav-item"><a href="">Edit Budget</a></li>
                <li class="nav-item"><a href="">Analyze Budget</a></li>
            </ul>
        </li>
        <li class="nav-item" id="nav-investment">
